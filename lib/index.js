...
module.exports = config => {
    ...
    let renderRss = () => {
        let domain = Bloggify.options.domain;
        ...
        Bloggify.getArticles({
            ...
            let feed = new Rss({
                title: config.title || Bloggify.options.title
              , description: config.description || Bloggify.options.description
